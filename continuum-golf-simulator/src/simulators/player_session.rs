...
mod tests {
    ...
    fn test_session_result_calculations() {
        let result = SessionResult {
            ...
            net_gain_loss: -12.0,
            shots: vec![
                ShotOutcome::new(10.0, 2.0, 10.0, 1, false, 10.0),
                ShotOutcome::new(30.0, 0.0, 10.0, 1, false, 10.0),
                ShotOutcome::new(15.0, 1.5, 10.0, 1, false, 10.0),
                ShotOutcome::new(8.0, 2.3, 10.0, 1, false, 10.0),
                ShotOutcome::new(25.0, 0.0, 10.0, 1, false, 10.0),
                ShotOutcome::new(12.0, 1.8, 10.0, 1, false, 10.0),
                ShotOutcome::new(20.0, 0.0, 10.0, 1, false, 10.0),
                ShotOutcome::new(9.0, 2.1, 10.0, 1, false, 10.0),
                ShotOutcome::new(30.0, 0.0, 10.0, 1, false, 10.0),
                ShotOutcome::new(11.0, 1.9, 10.0, 1, false, 10.0),
            ],
